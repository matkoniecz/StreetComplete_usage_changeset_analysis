...
This one may start slowly, but later it gets faster and completes download in about 45 minutes to download 3.2 GB file, which was faster than the ones listed below - at least for me.
...
This script is published as-is. It was used solely by author as far as author knows (PR removing that disclaimer is welcome if you used it successfully).
